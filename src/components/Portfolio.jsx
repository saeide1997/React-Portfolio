...
const Portfolio = () => {
    ...
    return (
        <div  className='bg-white flex flex-col items-center' id='Portfolio'>
            <h1 className='text-[40px] m-10 max-[640px]:text-[20px] '>نمونه کارهای انجام شده</h1>
            ...
            <div className='w-[70%] flex items-center justify-center flex-wrap max-[640px]:w-[100%]'>
                {data.map((item)=>(
            <div className='cursor-pointer flex flex-col tran w-[220px] h-[150px] relative border rounded-2xl border-solid mx-5 my-3 items-center justify-center hover:bg-violet-300/30 max-[640px]:w-[150px] max-[640px]:h-[120px]' style={{zIndex :"9"}}>
